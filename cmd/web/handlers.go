...
import (
	...
	"snippetbox.alexarmenta.net/internal/validator"
)
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valid email addres")
	...
	//aqui es donde tienes que hacer el pop!
